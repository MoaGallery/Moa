        <p class="settings_section_break" id="settings_server_title">
          Server settings.
        </p>
        <div id="settings_server" class="settings_block">
        ...
        <p class="settings_section_break" id="settings_db_title">
          Database settings.
        </p>
        <div id="settings_db" class="settings_block">
          <dl class="settings_form_items">
