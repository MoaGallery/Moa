      ...
      <fieldset class="formFieldset">
        <ul class="formList">
          <li>
            ...
            <img src="templates/MoaDefault/media/help.png" class="popupImage" title="<moatag type="FormPopupHelp" field="gal_name">" alt="popup help" />
          ...
          <li>
            ...
            <img src="templates/MoaDefault/media/help.png" class="popupImage" title="<moatag type="FormPopupHelp" field="gal_desc">" alt="popup help" />
          ...
          <li>
            ...
            <img src="templates/MoaDefault/media/help.png" class="popupImage" title="<moatag type="FormPopupHelp" field="gal_parent">" alt="popup help" />
