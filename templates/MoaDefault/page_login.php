      ...
      <fieldset class="formFieldset">
        <ul class="formList">
          <li>
            ...
            <img src="templates/MoaDefault/media/help.png" class="popupImage" title="<moatag type="FormPopupHelp" field="login_name">" alt="popup help" />
            <input id="loginname" type="text" name="name" class='form_text' />
          </li>

          <li>
            <label for="loginpass" class="formLabel">Password:</label>
            <img src="templates/MoaDefault/media/help.png" class="popupImage" title="<moatag type="FormPopupHelp" field="login_pass">" alt="popup help" />
            <input id="loginpass" type="password" name="password" class='form_text' />
          </li>

          <li>
            <label for="loginduration" class="formLabel">Duration:</label>
            <img src="templates/MoaDefault/media/help.png" class="popupImage" title="<moatag type="FormPopupHelp" field="login_duration">" alt="popup help" />
