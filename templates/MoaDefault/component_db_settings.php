        ...
        <fieldset id="settings_server" class="formSettingsFieldset settings_block">
          <ul class="formListSettings">
            <li>
              ...
              <img src="templates/MoaDefault/media/help.png" class="popupImage" title="<moatag type="FormPopupHelp" field="setting_moapath">" alt="popup help" />
            ...
            <li>
              ...
              <img src="templates/MoaDefault/media/help.png" class="popupImage" title="<moatag type="FormPopupHelp" field="setting_imagepath">" alt="popup help" />
            ...
            <li>
              ...
              <img src="templates/MoaDefault/media/help.png" class="popupImage" title="<moatag type="FormPopupHelp" field="setting_thumbpath">" alt="popup help" />
            ...
            <li>
              ...
              <img src="templates/MoaDefault/media/help.png" class="popupImage" title="<moatag type="FormPopupHelp" field="setting_cookiepath">" alt="popup help" />
            ...
            <li>
              ...
              <img src="templates/MoaDefault/media/help.png" class="popupImage" title="<moatag type="FormPopupHelp" field="setting_cookiename">" alt="popup help" />
            ...
            <li>
              ...
              <img src="templates/MoaDefault/media/help.png" class="popupImage" title="<moatag type="FormPopupHelp" field="setting_incomingpath">" alt="popup help" />
        ...
        <fieldset id="settings_db" class="formSettingsFieldset settings_block">
          <ul class="formListSettings">
            <li>
              ...
              <img src="templates/MoaDefault/media/help.png" class="popupImage" title="<moatag type="FormPopupHelp" field="setting_dbhost">" alt="popup help" />
            ...
            <li>
              ...
              <img src="templates/MoaDefault/media/help.png" class="popupImage" title="<moatag type="FormPopupHelp" field="setting_dbname">" alt="popup help" />
            ...
            <li>
              ...
              <img src="templates/MoaDefault/media/help.png" class="popupImage" title="<moatag type="FormPopupHelp" field="setting_dbuser">" alt="popup help" />
            ...
            <li>
              ...
              <img src="templates/MoaDefault/media/help.png" class="popupImage" title="<moatag type="FormPopupHelp" field="setting_dbpass">" alt="popup help" />
            ...
            <li>
              ...
              <img src="templates/MoaDefault/media/help.png" class="popupImage" title="<moatag type="FormPopupHelp" field="setting_tabprefix">" alt="popup help" />
