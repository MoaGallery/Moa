      ...
      <fieldset id="settings_general" class="formSettingsFieldset settings_block">
        ...
        <ul class="formListSettings">
          ...
          <li>
            ...
            <img src="templates/MoaDefault-blue/media/help.png" class="popupImage" title="<moatag type="FormPopupHelp" field="setting_empty_desc_popup">" alt="popup help" />
          ...
          <li>
            ...
            <img src="templates/MoaDefault-blue/media/help.png" class="popupImage" title="<moatag type="FormPopupHelp" field="setting_title_desc_length">" alt="popup help" />
          ...
          <li>
            ...
            <img src="templates/MoaDefault-blue/media/help.png" class="popupImage" title="<moatag type="FormPopupHelp" field="setting_str_delimiter">" alt="popup help" />
      ...
      <fieldset id="settings_visual" class="formSettingsFieldset settings_block">
        <ul class="formListSettings">
          <li>
            ...
            <img src="templates/MoaDefault-blue/media/help.png" class="popupImage" title="<moatag type="FormPopupHelp" field="setting_thumb_width">" alt="popup help" />
          ...
          <li>
            ...
            <img src="templates/MoaDefault-blue/media/help.png" class="popupImage" title="<moatag type="FormPopupHelp" field="setting_preview_width">" alt="popup help" />
          ...
          <li>
            ...
            <img src="templates/MoaDefault-blue/media/help.png" class="popupImage" title="<moatag type="FormPopupHelp" field="setting_plain_subgalleries">" alt="popup help" />
