<li id='tag_<moavar AdminTagID>'>
  ...
  <div class='tag_button' id='tag_edit_cancel_<moavar AdminTagID>'>
    <button id='tag_edit_cancel_button_<moavar AdminTagID>' class='tag_buttons' onclick='javascript: tag_list.CancelEdit("<moavar AdminTagID>")'>
      Cancel
    </button>
  </div>
  <div class='tag_button' id='tag_edit_submit_<moavar AdminTagID>'>
    <button id='tag_edit_submit_button_<moavar AdminTagID>' class='tag_buttons' onclick='javascript: tag_list.SubmitEdit("<moavar AdminTagID>")'>
      Save
    </button>
  </div>
</li>